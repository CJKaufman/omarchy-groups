...
assert.equal(Icons.catalogNames.length + Icons.originalNames.length, Icons.names.length)
assert(Icons.search('wireless signal').includes('wifi'))
assert.equal(Icons.search('rocket')[0], 'rocket', 'cached index retains exact-match priority')
